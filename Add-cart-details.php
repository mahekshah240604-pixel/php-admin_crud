...
$query=mysqli_query($connection,"insert into tbl_cartdetails(Product_id,item_qty,Customer_id) values('{$Product_id}','{$item_qty}','{$Customer_id}')") or die(mysqli_error($connection));
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<h2 class="title1">Cart-details forms</h2>
					<?php
					echo $msg;
					?>
								<h4>Add Cart-details infermation :</h4>
							</div>
							<div class="form-body">
								...
								<div class="form-group">
								 ...
								 <div class="col-sm-9">
								 <input type="number" class="form-control" id="inputEmail3" name="item_qty" placeholder="enter itey qty" required> 
								</div> </div> 
								...
								<button type="submit" class="btn btn-primary">Add cart-details</button>
								<button type="rester" class="btn btn-danger">reset</button>
								<button type="button"  onclick="window.location='display-cart-detils.php'; "class="btn btn-info">view</button>
								</div> 
								</form> 
							</div>
						</div>
