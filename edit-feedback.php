...
if($_POST)
{
    ...
    $Feedback_desc=mysqli_real_escape_string($connection,$_POST['Feedback_desc']);

$query=mysqli_query($connection,"update tbl_feedback set Feedback_date='{$Feedback_date}',Customer_id='{$Customer_id}',Product_id='{$Product_id}',Feedback_desc='{$Feedback_desc}' where Feedback_id='{$id}'") or die(mysqli_error($connection));

if($query)
{
	echo "<script>alert('record updataed');window.location='display-feedback.php';</script>";
}
					...
					?>
							...
							<div class="form-body">
								...
								<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Feedback_date</label> 
								 <div class="col-sm-9">
								 <input type="date" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Feedback_date'] ?>" name="Feedback_date" placeholder="enter Feedback_date" required> 
								</div> </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Feedback_desc</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Feedback_desc'] ?>" name="Feedback_desc" placeholder="enter Feedback desc" required> 
								</div> </div>
