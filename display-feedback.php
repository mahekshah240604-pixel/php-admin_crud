...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables"  >
					<h2 class="title1">feedback table</h2>
					<div style='overflow:scroll' class="panel-body widget-shadow">
						
						<a href="Add-feedback.php"><h4>feedback Details Add</h4></a>
						<table class="table" >
							<thead>
								<tr>
								  <th>#</th>
							...
							{
								$did=$_GET['did'];
								$delete=  mysqli_query($connection,"delete from tbl_feedback where  Feedback_id='{$did}'")or die(mysqli_error($connection));
								if($delete)
									{
                            ...
                            while($data=mysqli_fetch_array($selectq))
                            {
                                ...
                                echo "<td>{$data['Feedback_desc']}</td>";
                                echo "<td><a href='edit-feedback.php?eid={$data['Feedback_id']}'><img style='width:10px' src='my-img/edit.png'>Edit</a> | <a href='display-feedback.php?did={$data['Feedback_id']}'><img style='width:10px' src='my-img/delet.png'> delete</a></td>";
                                echo "</tr>";
                            }
                            ?>
