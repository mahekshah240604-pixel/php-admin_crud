...
$query=mysqli_query($connection,"insert into tbl_feedback(Feedback_date,Customer_id,Product_id,Feedback_desc) values('{$Feedback_date}','{$Customer_id}','{$Product_id}','{$Feedback_desc}')") or die(mysqli_error($connection));
					...
					?>
							...
							<div class="form-body">
								...
								<div class="form-group">
								 ...
								 <div class="col-sm-9">
								 <input type="date" class="form-control" id="inputEmail3" name="Feedback_date" placeholder="enter Feedback_date" required> 
								</div> </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
								 ...
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="Feedback_desc" placeholder="enter Feedback desc" required> 
								</div> </div>
