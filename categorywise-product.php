				...
				<div class="tables"  >
					...
					<div style='overflow:scroll' class="panel-body widget-shadow">
						...
						<a href="Add-product.php"><h4>product Details Add</h4></a>
                            ...
                            <tbody>
                                ...
                                <form method="get">
                                    ...
                                    echo "</select>";
                                    ?></br>
									Price1:<input type="number" name="p1">
									Price2:<input type="number" name="p2"></br>
                        ...
                        {                       
						  ...
						  $p1=$_GET['p1'];
						  $p2=$_GET['p2'];
                            $selectq=mysqli_query($connection,"select * from tbl_product where Category_id='{$cartid}' and Product_price between $p1 and $p2") or die(mysqli_error($connection));
                           ...
                           echo "<tr>";
								  ...
								  echo"<th>Product_details</th>";
								  echo"<th>Product_price</th>";
                                  echo"<th>Product_account</th>";
                                  echo"<th>Product_photopath</th>";
                            ...
                            while($data=mysqli_fetch_array($selectq))
                            {
                                ...
                                echo "<td>{$data['Product_account']}</td>";
                                echo "<td>{$data['Product_photopath']}</td>";
