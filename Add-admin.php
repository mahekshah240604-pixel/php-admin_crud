...
$query=mysqli_query($connection,"insert into tbl_admin(First_Name,Last_Name,Middle_Name,Admin_Mobile,Admin_Email,Aadharcard,Admin_Paasword,Login_Status,Admin_Gender) values('{$First_Name}','{$Last_Name}','{$Middle_Name}','{$Admin_Mobile}','{$Admin_Email}','{$Aadharcard}','{$Admin_Paasword}','{$Login_Status}','{$Admin_Gender}')") or die(mysqli_error($connection));
					...
					?>
							...
							<div class="form-body">
								...
								<div class="form-group">
								 ...
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="First_Name" placeholder="enter First Name" required> 
								</div> </div> 
								<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Last_Name</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="Last_Name" placeholder="enter Last Name" required> 
								</div> </div>
								<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Middle_Name</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="Middle_Name" placeholder="enter Middle Name" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Admin_Mobile</label> 
								 <div class="col-sm-9">
								 <input type="number" class="form-control" id="inputEmail3" name="Admin_Mobile" placeholder="enter Admin Mobile" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Admin_Email</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="Admin_Email" placeholder="enter Admin Email" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Aadharcard</label> 
								 <div class="col-sm-9">
								 <input type="number" class="form-control" id="inputEmail3" name="Aadharcard" placeholder="enter Aadharcard" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Admin_Paasword</label> 
								 <div class="col-sm-9">
								 <input type="password" class="form-control" id="inputEmail3" name="Admin_Paasword" placeholder="enter Admin Paasword" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Login_Status</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="Login_Status" placeholder="enter Login Status" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Admin_Gender</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="Admin_Gender" placeholder="enterAdmin Gender" required> 
								</div> </div>
