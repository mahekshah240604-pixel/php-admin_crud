...
$query=mysqli_query($connection,"update tbl_ordermaster set Order_date='{$Order_date}',Customer_id='{$Customer_id}',Order_shiping_name='{$Order_shiping_name}',Order_satetus='{$Order_satetus}',Order_paymentmode='{$Order_paymentmode}',Oreder_shipping_address='{$Oreder_shipping_address}',Oreder_shipping_mobile='{$Oreder_shipping_mobile}' where Order_id='{$id}'") or die(mysqli_error($connection));

if($query)
{
	echo "<script>alert('record updataed');window.location='display-order.php';</script>";
}
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<h2 class="title1">order forms</h2>
					<?php
					echo $msg;
					?>
							...
							<div class="form-body">
								...
								<input type="hidden" name="id" value="<?php echo $selectrow['Order_id'] ?>">
								<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Order_date</label> 
								 <div class="col-sm-9">
								 <input type="date" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Order_date'] ?>" name="Order_date" placeholder="enter Order date" required> 
								</div> </div> 
								<div class="form-group">
                                ...
                                <div class="form-group">
								 ...
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Order_shiping_name'] ?>" name="Order_shiping_name" placeholder="enter Order shiping name" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Order_satetus</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Order_satetus'] ?>" name="Order_satetus" placeholder="enterOrder satetus" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Order_paymentmode</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Order_paymentmode'] ?>" name="Order_paymentmode" placeholder="enterOrder paymentmode" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Oreder_shipping_address</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Oreder_shipping_address'] ?>" name="Order_deliverydate" placeholder="enterOrder deliverydate" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Oreder_shipping_mobile</label> 
								 <div class="col-sm-9">
								 <input type="number" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Oreder_shipping_mobile'] ?>" name="Total_amt" placeholder="enterTotal amt" required> 
								</div> </div>
