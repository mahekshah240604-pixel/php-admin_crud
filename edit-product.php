...
$selectq=mysqli_query($connection,"select * from tbl_product where Product_id='{$editid}' ") or die(mysqli_error($connection));
...
$query=mysqli_query($connection,"update tbl_product set Product_name='{$Product_name}',Product_details='{$Product_details}',Product_price='{$Product_price}',Product_account='{$Product_account}',Product_photopath='{$Product_photopath}',Category_id='{$Category_id}' where Product_id='{$id}'") or die(mysqli_error($connection));

if($query)
{
	echo "<script>alert('record updataed');window.location='display-product.php';</script>";
}
					...
					?>
							...
							<div class="form-body">
								...
								<div class="form-group">
								 ...
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Product_name'] ?>" name="Product_name" placeholder="enter Product name" required> 
								</div> </div>
								<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Product_details</label> 
								 <div class="col-sm-9">
                                 <textarea class="form-control"name="Product_details" required> <?php echo $selectrow['Product_details'] ?> </textarea>								
                                </div> </div>
								<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Product_price</label> 
								 <div class="col-sm-9">
								 <input type="number" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Product_price'] ?>" name="Product_price" placeholder="enter Middle Name" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Product_account</label> 
								 <div class="col-sm-9">
								 <input type="number" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Product_account'] ?>"  name="Product_account" placeholder="enter Product account" required> 
								</div> </div>
                                <div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Product_photopath</label> 
								 <div class="col-sm-9">
								 <input type="file" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Product_photopath'] ?>"  name="Product_photopath" placeholder="enter Product photopath" required> 
								</div> </div>
                                <div class="form-group">
								 ...
								 <div class="col-sm-9">
                                    <?php
                                        ...
                                        echo "</select>";
                                    ?>
                                    value="<?php echo $selectrow['Category_id'] ?>"
								</div> </div>
