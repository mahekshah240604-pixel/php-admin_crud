				...
				<div class="tables"  >
					...
					<div style='overflow:scroll' class="panel-body widget-shadow">
						...
						<table class="table" >
							...
							{
								$did=$_GET['did'];
								$delete=  mysqli_query($connection,"delete from tbl_product where  Product_id='{$did}'")or die(mysqli_error($connection));
								if($delete)
									{
                            ...
                            while($data=mysqli_fetch_array($selectq))
                            {
                                ...
                                echo "<td><a href='edit-product.php?eid={$data['Product_id']}'><img style='width:10px' src='my-img/edit.png'>Edit</a> | <a href='display-product.php?did={$data['Product_id']}'><img style='width:10px' src='my-img/delet.png'> delete</a></td>";
                                echo "</tr>";
                            }
                            ?>
