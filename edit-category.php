...
$query=mysqli_query($connection,"update tbl_category set Category_name='{$Category_name}' where Category_id='{$id}'") or die(mysqli_error($connection));
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<h2 class="title1">category forms</h2>
					<?php
					echo $msg;
					?>
								<h4>Add category infermation :</h4>
							</div>
							<div class="form-body">
								...
								<div class="form-group">
								 ...
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['Category_name'] ?>" name="Category_name" placeholder="enter Category name" required> 
								</div> </div> 
