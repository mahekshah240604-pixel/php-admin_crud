			...
			<div class="main-page">
				<div class="tables"  >
					...
					<div style='overflow:scroll' class="panel-body widget-shadow">
						...
						<a href="Add-category.php"><h4>category Details Add</h4></a>
						<table class="table" >
							<thead>
								<tr>
								  <th>#</th>
							...
							{
								$did=$_GET['did'];
								$delete=  mysqli_query($connection,"delete from tbl_category where  Category_id='{$did}'")or die(mysqli_error($connection));
								if($delete)
									{
                            ...
                            while($categoryrow=mysqli_fetch_array($selectq))
                            {
                                ...
                                echo "<td><a href='edit-category.php?eid={$categoryrow['Category_id']}'><img style='width:10px' src='my-img/edit.png'>Edit</a> | <a href='display-category.php?did={$categoryrow['Category_id']}'><img style='width:10px' src='my-img/delet.png'> delete</a></td>";
                                echo "</tr>";
                            }
                            ?>
