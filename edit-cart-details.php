...
{
	header("location:display-cart-details.php");
}


$selectq=mysqli_query($connection,"select * from tbl_cartdetails where Cartdetails_id='{$editid}' ") or die(mysqli_error($connection));
...
$query=mysqli_query($connection,"update tbl_cartdetails set Product_id='{$Product_id}',item_qty='{$item_qty}',Customer_id='{$Customer_id}' where Cartdetails_id='{$id}'") or die(mysqli_error($connection));

if($query)
{
	echo "<script>alert('record updataed');window.location='display-cart-details.php';</script>";
}
				...
				<div class="forms">
					...
					?>
							...
							<div class="form-body">
								...
								<input type="hidden" name="id" value="<?php echo $selectrow['Cartdetails_id'] ?>">
								...
								<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">item_qty</label> 
								 <div class="col-sm-9">
								 <input type="number" class="form-control" id="inputEmail3" value="<?php echo $selectrow['item_qty'] ?>" name="item_qty" placeholder="enter itey qty" required> 
								</div> </div> 
								...
								<button type="button"  onclick="window.location='display-cart-details.php'; "class="btn btn-info">view</button>
								</div> 
								</form> 
							</div>
						</div>
