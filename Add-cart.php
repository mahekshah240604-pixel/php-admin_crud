...
if($_POST)
{
	$Cart_total=mysqli_real_escape_string($connection,$_POST['Cart_total']);
	$Customer_id=mysqli_real_escape_string($connection,$_POST['Customer_id']);


$query=mysqli_query($connection,"insert into tbl_cart(Cart_total,Customer_id) values('{$Cart_total}','{$Customer_id}'") or die(mysqli_error($connection));
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<h2 class="title1">Cart forms</h2>
					<?php
					echo $msg;
					?>
								<h4>Add Cart infermation :</h4>
							</div>
							<div class="form-body">
								<form class="form-horizontal" method="post" enctype="multipart/form-data"> 
								<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">Cartdetails_id</label> 
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="Cartdetails_id" placeholder="enter Cartdetails id" required> 
								</div> </div>
								<div class="form-group">
								...
								<div class="form-group">
								 ...
								 <div class="col-sm-9">
								 <input type="text" class="form-control" id="inputEmail3" name="item_qty" placeholder="enter item_qty" required> 
								</div> </div> 
								...
								<button type="button"  onclick="window.location='display-cart.php'; "class="btn btn-info">view</button>
								</div> 
								</form> 
							</div>
						</div>
