...
$query=mysqli_query($connection,"insert into tbl_orderdetails(Order_id,Order_quantity,Product_id,Sub_total) values('{$Order_id}','{$Order_quantity}','{$Product_id}','{$Sub_total}')") or die(mysqli_error($connection));
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<h2 class="title1">order-details forms</h2>
					<?php
					echo $msg;
					?>
								<h4>Add order-details infermation :</h4>
							</div>
							<div class="form-body">
